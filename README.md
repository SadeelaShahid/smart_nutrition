...
Start MySQL from XAMPP, then open phpMyAdmin and create database named `smart\_nutrition`.
...
|`meal\_plans`|Generated meal plans with BMI data|
|`sessions`|User sessions|
|`cache`|Application cache|
|`jobs`|Queue jobs|

### meal\_plans table fields

* `user\_id` — linked to users table
* `age` — user age
* `height` — height in cm
* `weight` — weight in kg
* `bmi` — calculated BMI value
* `bmi\_category` — Underweight / Normal / Overweight / Obese
* `meal\_plan` — 7-day AI generated meal plan text
